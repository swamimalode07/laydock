"use client"
import { ChevronLeft, MenuIcon, Plus, PlusCircle, Search, Trash, User2Icon, UserIcon } from 'lucide-react'
  ...
  return (
    ...
    isMobile && "opacity-100"
      ...
      <ChevronLeft className='h-6 w-6'/>
        ...
        <div>
            <UserItem/>
            <Item title='Search' icon={Search} isSearch onClick={search.onOpen}/>
            <Item title='Settings' icon={Settings}  onClick={settings.onOpen}/>
